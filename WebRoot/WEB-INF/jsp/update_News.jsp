...
<table class="table table-bordered table-hover definewidth m10" style="margin-left:3%;margin-top:2%;">
    <tr>
        ...
        <td><input type="text" name="title" style="height: 41px; width: 546px" value="${requestScope.news.title}"/></td>
     
    </tr>
    <tr>
        <td class="tableleft">新闻内容</td>
        <td><textarea name="content" style="height: 200px; width: 546px" rows="" cols="">${requestScope.news.content}</textarea></td>
    </tr> 
  	<tr>
...
<script type="text/javascript">
	$(function(){
		...
		if($("[name=title]").val()!=""&&$("[name=content]").val()!=""){
				$.post("update_News",{"title":$("[name=title]").val(),
